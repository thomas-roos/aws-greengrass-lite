...
struct Keys {
    ...
    ggapi::Symbol serviceName{"aws.greengrass.FleetProvisioning"};
...
class FleetProvisioning : public ggapi::Plugin {
...
public:
    ...
    static FleetProvisioning &get() {
        static FleetProvisioning instance;
        return instance;
    }
