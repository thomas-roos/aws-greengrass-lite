...
const Keys FleetProvisioning::keys{};
 ...
 */
ggapi::Promise FleetProvisioning::brokerListener(ggapi::Symbol, const ggapi::Container &) {
    setDeviceConfig();
    return ggapi::Promise::create().async(&FleetProvisioning::provisionDevice, this);
}
...
void FleetProvisioning::onInitialize(ggapi::Struct data) {
    ...
    _subscription = ggapi::Subscription::subscribeToTopic(
        keys.topicName, ggapi::TopicCallback::of(&FleetProvisioning::brokerListener, this));
 ...
 */
void FleetProvisioning::onStop(ggapi::Struct data) {
    std::unique_lock guard{_mutex};
    _subscription.close();
}
 ...
 */
void FleetProvisioning::provisionDevice(ggapi::Promise promise) {
    promise.fulfill([this]() {
        if(initMqtt()) {
            try {
                ...
                response.put("dataEndpoint", _deviceConfig.endpoint);
                response.put("credEndpoint",_deviceConfig.credEndpoint);
                return response;
 ...
 */
void FleetProvisioning::setDeviceConfig() {
    ...
    _deviceConfig.credEndpoint = serviceConfig.getValue<std::string>({"iotCredEndpoint"});
 ...
 */
bool FleetProvisioning::initMqtt() {
 ...
 */
void FleetProvisioning::generateCredentials() {
 ...
 */
uint64_t FleetProvisioning::getPortFromProxyUrl(const Aws::Crt::String &proxyUrl) {
 ...
 */
Aws::Crt::String FleetProvisioning::getHostFromProxyUrl(const Aws::Crt::String &proxyUrl) {
 ...
 */
void FleetProvisioning::registerThing() {
