...
namespace pubsub {
    ...
    Listener::Listener(data::Environment &environment, data::StringOrd topicOrd, Listeners *receivers,
                               std::unique_ptr<AbstractCallback> &callback) :
            data::TrackedObject{environment},
            _topicOrd{topicOrd},
            _parent{receivers->weak_from_this()},
            _callback{std::move(callback)} {

    }

    Listeners::Listeners(data::Environment &environment, data::StringOrd topicOrd,
    ...
    Listeners::newReceiver(std::unique_ptr<AbstractCallback> &callback) {
    ...
    data::ObjectAnchor PubSubManager::subscribe(data::ObjHandle anchor, data::StringOrd topicOrd,
                                                        std::unique_ptr<AbstractCallback> &callback) {
    ...
    void PubSubManager::insertCallQueue(std::shared_ptr<tasks::Task> &task, data::StringOrd topicOrd) {
        std::shared_ptr<Listeners> receivers = tryGetListeners(topicOrd);
    ...
    public:
        explicit ReceiverSubTask(std::shared_ptr<Listener> &receiver) :
                _receiver{receiver} {
        }

        std::shared_ptr<data::StructModelBase> runInThread(const std::shared_ptr<tasks::Task> &task,
    ...
    std::shared_ptr<data::StructModelBase> ReceiverSubTask::runInThread(const std::shared_ptr<tasks::Task> &task,
                                                                        const std::shared_ptr<data::StructModelBase> &dataIn) {
        return _receiver->runInTaskThread(task, dataIn);
    }

    std::shared_ptr<data::StructModelBase> Listener::runInTaskThread(const std::shared_ptr<tasks::Task> &task,
                                                                             const std::shared_ptr<data::StructModelBase> &dataIn) {
    ...
    std::shared_ptr<data::StructModelBase> CompletionSubTask::runInThread(const std::shared_ptr<tasks::Task> &task,
    ...
    std::unique_ptr<tasks::SubTask> CompletionSubTask::of(data::StringOrd topicOrd, std::unique_ptr<AbstractCallback> callback) {
