...
There is a arm64 and x86-64 version available of this zip file.
For the latest version, as well as other install options look here:
https://github.com/aws-greengrass/aws-greengrass-lite/releases

This package has been build from this source:
{{ VERSION_LINK }}
...
copy ConnectionKit zip onto your device
(e.g. scp, usb stick, mounting fat partition (Raspberry Pi))

The three files should be in the same folder on the device.

On the device run installation script, this will automatically detect a
*.deb and *.zip for installation in the same dir:
...
Be careful this will delete /etc/greengrass without asking!
